...
const utilitiesData = ["Electricity", "Gas", "Maintenance", "Water"];
      ...
      <PropertyDetailsStyle>
        <Container>
          <div className="d-flex justify-content-between align-items-center">
            <SecondaryHeadingMini>
              Sensational And Brilliant Bungalow In Calgary!
            </SecondaryHeadingMini>
            <h5 className="for-sale">For Sale</h5>
          </div>
          <div className="d-flex justify-content-between align-items-center">
            <TertiraryHeading1 className="mt-2">
              83 Woodford Crescent Southwest, Calgary, Alberta, Canada
            </TertiraryHeading1>
          ...
          <div className="about-property">
            <div className="about-property-main-details">
              <h6 className="about-property-main-details-title">
                About this property
              </h6>
              ...
              <p className="posted-at-area">
                4500 Sq. Ft. House for Sale in Calgary!
              </p>
              <p className="posted-at-detail-text">
                A grand 2400 sq. ft. house for sale in E-11/3, Islamabad. It
                comprises of 10 bedrooms, 12 washrooms, TV lounge, 3 drawing &
                dining rooms, store room, servant quarters and car parking
                space. Key lifestyle and convenience around this property
                includes beautiful parks, commercial area, Restaurants and food
                outlets, medical care/ hospital, gym, health/sports centre
                within 1-2 KMs. Margalla Road can be used for daily commute.
              </p>
            </div>
