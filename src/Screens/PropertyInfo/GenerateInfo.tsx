...
const GenerateInfo = () => {
  const [additionalInputs, setAdditionalInputs] = useState([
    { title: "Bedrooms", name: "bedroom", value: "" },
    { title: "Bathroom", name: "bathroom", value: "" },
    { title: "Drawing Rooms", name: "drawingRooms", value: "" },
    { title: "Bath", name: "bath", value: "" },
    { title: "Dining Room", name: "diningRoom", value: "" },
    { title: "Store Rooms", name: "storeRooms", value: "" },
    { title: "Kitchens", name: "kitchens", value: "" },
    { title: "Servant Rooms", name: "servantRooms", value: "" },
    { title: "Parking Space", name: "parkingSpace", value: "" },
  ]);
