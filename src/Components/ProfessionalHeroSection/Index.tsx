import ProfessionalHeroSectionStyle from "./style";
      ...
      <ProfessionalHeroSectionStyle>
        ...
        <div className="inner-container d-flex align-items-center flex-column justify-content-center">
          <h4 className="inner-container-main-heading">
            <span>
              Find <span className="professional-text">Professional </span> such
              as
            </span>
          ...
          <Row className="location-select-section d-flex justify-content-sm-between justify-content-center p-3 align-items-center mx-2">
            ...
            <Col
              sm={6}
              className="property-type d-flex justify-content-sm-between justify-content-center mt-2 mt-sm-0"
            >
              <div className="left-section ps-4">
                <h5 className="title">Professional Type</h5>
                <h6 className="sub-title">All Professional</h6>
              </div>
